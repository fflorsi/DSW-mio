...
async function add(req, res) {
    ...
    const clientInput = new Client(input.dni, input.firstname, input.lastname, input.address, input.phone, input.email, input.registrationDate);
    try {
...
async function findClientAndPetsByDni(req, res) {
